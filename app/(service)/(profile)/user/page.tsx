        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start mb-12">
          ...
          <div className="lg:col-span-5 pt-2">
            ...
            <div className="flex gap-4 mb-8">
              <button className="flex-1 py-3.5 px-4 rounded-lg text-white font-semibold flex items-center justify-center gap-2 bg-gradient-to-r from-[#C5A059] to-[#B08C45] hover:brightness-105 transition-all shadow-md">
                <Edit className="w-4 h-4" />
                Edit Profile
              </button>
              <button className="flex-1 py-3.5 px-4 rounded-lg border-2 border-[#000d22] text-[#000d22] font-semibold flex items-center justify-center gap-2 hover:bg-[#000d22]/5 transition-all">
